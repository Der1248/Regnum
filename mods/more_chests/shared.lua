...
minetest.register_node("more_chests:shared", {
	description = "Looked Uran chest+outher player",
	tiles = {"tutorial_uran_chest_top.png", "tutorial_uran_chest_side.png", "tutorial_uran_chest_side.png",
		"tutorial_uran_chest_side.png", "tutorial_uran_chest_side.png", "tutorial_uran_chest_front_lockp.png"},
	paramtype2 = "facedir",
...
minetest.register_craft({
	...
	recipe = {
		...
		{'tutorial:uranium9','tutorial:admin','tutorial:uranium9'},
		{'tutorial:uranium9','tutorial:uranium9','tutorial:uranium9'},
	}
})
