			...
			if self.owner == sender:get_player_name() then
				if fields.texture1 then
					...
					if self.owner ~= sender:get_player_name() then
						...
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Dog", "")
				...
				if fields.texture21 then
					...
					if self.owner ~= sender:get_player_name() then
						...
						local formspec = "size[3,1]"
						.."label[0,0;You are not the owner!!]"
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Cat", "")
                ...
                if fields.texture41 then
					...
					if self.owner ~= sender:get_player_name() then
						...
						local formspec = "size[3,1]"
						.."label[0,0;You are not the owner!!]"
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Dragon", "")
                        ...
                        .."label[1,1;Dragon produce a dragon/gem gift after some time]"
                        .."label[2.4,3.5;Regnum cristall for gem gift]"
					    .."list[current_player;main;0,4.5;8,4]"
                ...
                if fields.move31 then
					...
					if self.owner ~= sender:get_player_name() then
						...
						local formspec = "size[3,1]"
						.."label[0,0;You are not the owner!!]"
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Sheep", "")
                ...
                if fields.move51 then
				    ...
				    if self.owner ~= sender:get_player_name() then
					    ...
					    local formspec = "size[3,1]"
					    .."label[0,0;You are not the owner!!]"
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Knight", "")
