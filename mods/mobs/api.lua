...
function mobs:register_mob(name, def)
	minetest.register_entity(name, {
		...
		lifetimer = def.lifetimer or 1800000000000000000000, -- 3 minutes
		hp_min = def.hp_min,
		hp_max = def.hp_max,
		physical = true,
			...
			if self.owner == sender:get_player_name() then
				if fields.texture1 then
					...
					if self.owner ~= sender:get_player_name() then
						...
						.."button[0,0;2.0,0.5;texture2;Texture:grey]"
				...
				if fields.texture21 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;texture22;Texture:sandy]"
						if self.metadata2 == 1 then
						formspec = formspec .."button[3,0;2.0,0.5;move21;Move:stand]"
						end
						if self.metadata2 == 2 then
						formspec = formspec .."button[3,0;2.0,0.5;move22;Move:follow]"
						end
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Cat", formspec)
					end
				end
				if fields.texture2 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dog]"
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;texture1;Texture:brown]"
						if self.metadata2 == 1 then
						formspec = formspec .."button[3,0;2.0,0.5;move1;Move:stand]"
						end
						if self.metadata2 == 2 then
				...
				if fields.texture22 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;cat]"
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;texture23;Texture:splotchy]"
						if self.metadata2 == 1 then
						formspec = formspec .."button[3,0;2.0,0.5;move21;Move:stand]"
						end
						if self.metadata2 == 2 then
				...
				if fields.texture23 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;cat]"
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;texture24;Texture:striped]"
						if self.metadata2 == 1 then
						formspec = formspec .."button[3,0;2.0,0.5;move21;Move:stand]"
						end
						if self.metadata2 == 2 then
				...
				if fields.texture24 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;cat]"
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;texture21;Texture:ginger]"
						if self.metadata2 == 1 then
						formspec = formspec .."button[3,0;2.0,0.5;move21;Move:stand]"
						end
						if self.metadata2 == 2 then
                ...
                if fields.texture41 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture42;Texture:blue]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
					    formspec = formspec .."button[3,0;2.0,0.5;move42;Move:follow]"
					    end
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Dragon", formspec)
					end
				end
                if fields.texture42 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture43;Texture:green]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
                ...
                if fields.texture43 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture44;Texture:black]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
                ...
                if fields.texture44 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture45;Texture:great]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
                ...
                if fields.texture45 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture46;Texture:red]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
                ...
                if fields.texture46 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;texture41;Texture:yellow]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move41;Move:stand]"
					    end
					    if self.metadata2 == 2 then
                ...
                if fields.texture61 then
					...
					if self.owner ~= sender:get_player_name() then
					    ...
					    local player_name = sender:get_player_name()
					    local formspec = "size[8,8.5]"
                        .."label[0,1.2;Fox produce a Foxkey after some time]"
					    .."button[0,0;2.0,0.5;texture62;Texture:dark]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move61;Move:stand]"
					    end
					    if self.metadata2 == 2 then
					    formspec = formspec .."button[3,0;2.0,0.5;move62;Move:follow]"
					    end
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Fox", formspec)
				    end
				end
                if fields.texture62 then
					...
					if self.owner ~= sender:get_player_name() then
					    ...
					    local formspec = "size[8,8.5]"
                        .."label[0,1.2;Fox produce a Foxkey after some time]"
					    .."button[0,0;2.0,0.5;texture61;Texture:light]"
					    if self.metadata2 == 1 then
					    formspec = formspec .."button[3,0;2.0,0.5;move61;Move:stand]"
					    end
					    if self.metadata2 == 2 then
				...
				if fields.move1 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dog]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move2;Move:follow]"
						if self.metadata == 1 then
						formspec = formspec .."button[0,0;2.0,0.5;texture1;Texture:brown]"
						end
						if self.metadata == 2 then
						formspec = formspec .."button[0,0;2.0,0.5;texture2;Texture:grey]"
						end
						
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Dog", formspec)
					end
				end
                if fields.move41 then
					self.walk_velocity = 0
					self.run_velocity = 0
					self.metadata2 = 2
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move42;Move:follow]"
						if self.metadata == 1 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture41;Texture:yellow]"
					    end
					    if self.metadata == 2 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture42;Texture:blue]"
					    end
					    if self.metadata == 3 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture43;Texture:green]"
					    end
					    if self.metadata == 4 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture44;Texture:black]"
					    end
                        if self.metadata == 5 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture45;Texture:great]"
					    end
                        if self.metadata == 6 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture46;Texture:red]"
					    end
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Dragon", formspec)
					end
				end
                if fields.move42 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dragon]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move41;Move:stand]"
						if self.metadata == 1 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture41;Texture:yellow]"
					    end
					    if self.metadata == 2 then
				...
				if fields.move21 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;cat]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move22;Move:follow]"
						if self.metadata == 1 then
                ...
                if fields.move31 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;move32;Move:follow]"
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Sheep", formspec)
					end
				end
				if fields.move2 then
					self.walk_velocity = 1
					self.run_velocity = 3
					self.metadata2 = 1
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;dog]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move1;Move:stand]"
						if self.metadata == 1 then
						formspec = formspec .."button[0,0;2.0,0.5;texture1;Texture:brown]"
						end
						if self.metadata == 2 then
				...
				if fields.move22 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;cat]"
                        .."listring[current_player;main]"
                        .."button[3,0;2.0,0.5;move21;Move:stand]"
						if self.metadata == 1 then
						formspec = formspec .."button[0,0;2.0,0.5;texture21;Texture:ginger]"
						end
						if self.metadata == 2 then
                ...
                if fields.move32 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;sheep]"
                        .."listring[current_player;main]"
						.."button[0,0;2.0,0.5;move31;Move:stand]"
						minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Sheep", formspec)
					end
				end
                if fields.move61 then
					self.walk_velocity = 0
					self.run_velocity = 0
					self.metadata2 = 2
					if self.owner ~= sender:get_player_name() then
					    ...
					    local formspec = "size[8,8.5]"
                        .."label[0,1.2;Fox produce a Foxkey after some time]"
                        .."button[3,0;2.0,0.5;move62;Move:follow]"
					    if self.metadata == 1 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture61;Texture:light]"
					    end
					    if self.metadata == 2 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture62;Texture:dark]"
					    end
					    
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Fox", formspec)
				    end
				end
                if fields.move62 then
					self.walk_velocity = 1
					self.run_velocity = 3
					self.metadata2 = 1
					if self.owner ~= sender:get_player_name() then
					    ...
					    local formspec = "size[8,8.5]"
                        .."label[0,1.2;Fox produce a Foxkey after some time]"
                        .."button[3,0;2.0,0.5;move61;Move:stand]"
					    if self.metadata == 1 then
					    formspec = formspec .."button[0,0;2.0,0.5;texture61;Texture:light]"
					    end
					    if self.metadata == 2 then
                ...
                if fields.move71 then
					...
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;totoise]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;move72;Move:follow]"
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Tortoise", formspec)
				    end
				end
                if fields.move72 then
					self.walk_velocity = 1
					self.run_velocity = 3
					self.metadata2 = 1
					if self.owner ~= sender:get_player_name() then
                        ...
                        .."listring[current_player;totoise]"
                        .."listring[current_player;main]"
					    .."button[0,0;2.0,0.5;move71;Move:stand]"
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Tortoise", formspec)
				    end
				end
                if fields.move51 then
				    self.walk_velocity = 0
				    self.run_velocity = 0
				    self.metadata2 = 2
				    if self.owner ~= sender:get_player_name() then
					    ...
					    local player_name = sender:get_player_name()
					    local formspec = "size[2.0,0.5]"
					    .."button[0,0;2.0,0.5;move52;Move:follow]"
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Knight", formspec)
				    end
			    end
                if fields.move52 then
				    self.walk_velocity = 1
				    self.run_velocity = 3
				    self.metadata2 = 1
				    if self.owner ~= sender:get_player_name() then
					    ...
					    local player_name = sender:get_player_name()
					    local formspec = "size[2.0,0.5]"
					    .."button[0,0;2.0,0.5;move51;Move:stand]"
					    minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Knight", formspec)
				    end
			    end
            end
		...
		on_rightclick = function(self, clicker)
            ...
            if self.name == "mobs:sheep" then
				if self.owner ~= clicker:get_player_name() then
                    ...
                    .."listring[current_player;main]"
					if self.metadata2 == 1 then
					formspec = formspec .."button[0,0;2.0,0.5;move31;Move:stand]"
					end
					if self.metadata2 == 2 then
					formspec = formspec .."button[0,0;2.0,0.5;move32;Move:follow]"
					end
					minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Sheep", formspec)
				end
			end
            ...
            if self.name == "mobs:tortoise" then
				if self.owner ~= clicker:get_player_name() then
                    ...
                    .."listring[current_player;main]"
					if self.metadata2 == 1 then
					formspec = formspec .."button[0,0;2.0,0.5;move71;Move:stand]"
					end
					if self.metadata2 == 2 then
					formspec = formspec .."button[0,0;2.0,0.5;move72;Move:follow]"
					end
					minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Tortoise", formspec)
				end
			end
            if self.name == "mobs:knight_1248" then
				if self.owner ~= clicker:get_player_name() then
					...
					local formspec = "size[2.0,0.5]"
					if self.metadata2 == 1 then
					formspec = formspec .."button[0,0;2.0,0.5;move51;Move:stand]"
					end
					if self.metadata2 == 2 then
					formspec = formspec .."button[0,0;2.0,0.5;move52;Move:follow]"
					end
					minetest.show_formspec(player_name, "npcf_"..self.owner.."'s Knight", formspec)
				end
			end
