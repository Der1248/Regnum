...
zcg.formspec = function(pn)
	...
	if zcg.users[pn].history.index > 1 then
		formspec = formspec .. "image_button[0,2;1,1;zcg_previous.png;zcg_previous;;false;false;zcg_previous_press.png]"
	else
		formspec = formspec .. "image[0,2;1,1;zcg_previous_inactive.png]"
	end
	if zcg.users[pn].history.index < #zcg.users[pn].history.list then
		formspec = formspec .. "image_button[1,2;1,1;zcg_next.png;zcg_next;;false;false;zcg_next_press.png]"
	else
		formspec = formspec .. "image[1,2;1,1;zcg_next_inactive.png]"
	end
	-- Show craft recipe
