...
minetest.register_tool("3d_armor:helmet_admin", {
	...
	groups = {armor_head=20, armor_heal=25, armor_use=0, armor_fire=1, armor_water=0.2},
	wear = 0,
...
minetest.register_tool("3d_armor:helmet_admin3", {
    ...
    wield_image = "3d_armor_inv_helmet_admin.png",
	groups = {armor_head=20, armor_heal=25, armor_use=0, armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:helmet_admin4", {
    ...
    wield_image = "3d_armor_inv_helmet_admin.png",
	groups = {armor_head=20, armor_heal=25, armor_use=0, armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:chestplate_admin", {
	...
	groups = {armor_torso=20, armor_heal=25, armor_use=0, armor_fire=1, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:chestplate_admin2", {
    ...
    wield_image = "3d_armor_inv_chestplate_admin.png",
	groups = {armor_torso=20, armor_heal=25, armor_use=0, armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:leggings_admin2", {
	...
	groups = {armor_legs=20, armor_heal=25, armor_use=0, armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:leggings_admin3", {
	...
	groups = {armor_legs=20, armor_heal=25, armor_use=0, armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
...
minetest.register_tool("3d_armor:leggings_admin4", {
    ...
    wield_image = "3d_armor_inv_leggings_admin.png",
	groups = {armor_legs=20, armor_heal=25, armor_use=0, armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
        if keys["sneak"] == true then
