...
if minetest.get_modpath("inventory_plus") then
	...
	armor.formspec = "size[10,9.5]button[0,0;2,0.5;inven;Back]"
        ...
        .."label[5,2.5.5;Speed:  armor_speed]"
		.."label[5,3;Jump:  armor_jump]"
		.."label[7.7,1;Armor key]"
        .."list[current_player;main;1,5.5;8,1;]"
		.."list[current_player;main;1,6.75;8,3;8]"
		.."list[current_player;arm;8,0;1,1;]"
...
armor.get_armor_formspec = function(self, name)
 ...
 formspec = formspec:gsub("armor_speed", (armor.def[name].speed-1)*4)
	if am == 1 then
		formspec = formspec .."button[7.5,1.7;2,0.5;armon;armor on]"
	else
		formspec = formspec .."button[7.5,1.7;2,0.5;armoff;armor off]"
