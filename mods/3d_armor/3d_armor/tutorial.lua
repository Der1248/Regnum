...
minetest.register_tool("3d_armor:regnumboots", {
	...
	groups = {armor_feet=15.0, armor_heal=15, armor_use=0,armor_fire=1, armor_water=0.2},
	wear = 0,
...
minetest.register_tool("3d_armor:regnumboots2", {
	...
	groups = {armor_feet=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumboots.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumboots3", {
	...
	groups = {armor_feet=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumboots.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumboots4", {
	...
	groups = {armor_feet=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumboots.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumchestplate", {
	...
	groups = {armor_torso=15.0, armor_heal=15, armor_use=0, armor_fire=1, armor_water=0.2},
	wear = 0,
...
minetest.register_tool("3d_armor:regnumchestplate2", {
	...
	groups = {armor_torso=15.0, armor_heal=15, armor_use=0, armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumchestplate.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumchestplate3", {
	...
	groups = {armor_torso=15.0, armor_heal=15, armor_use=0, armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumchestplate.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumchestplate4", {
	...
	groups = {armor_torso=15.0, armor_heal=15, armor_use=0, armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumchestplate.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumhelmet", {
	...
	groups = {armor_head=15.0, armor_heal=15, armor_use=0,armor_fire=1, armor_water=0.2},
	wear = 0,
...
minetest.register_tool("3d_armor:regnumhelmet2", {
	...
	groups = {armor_head=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumhelmet.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumhelmet3", {
	...
	groups = {armor_head=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumhelmet.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumhelmet4", {
	...
	groups = {armor_head=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumhelmet.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumleggings", {
	...
	groups = {armor_legs=15.0, armor_heal=15, armor_use=0,armor_fire=1, armor_water=0.2},
	wear = 0,
...
minetest.register_tool("3d_armor:regnumleggings2", {
	...
	groups = {armor_legs=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumleggings.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumleggings3", {
	...
	groups = {armor_legs=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumleggings.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
...
minetest.register_tool("3d_armor:regnumleggings4", {
	...
	groups = {armor_legs=15.0, armor_heal=15, armor_use=0,armor_fire=1, physics_jump=0.25, physics_speed=0.25, armor_water=0.2},
	wear = 0,
    wield_image = "3d_armor_inv_regnumleggings.png",
    on_use = function(itemstack, user, pointed_thing)
        local keys = user:get_player_control()
