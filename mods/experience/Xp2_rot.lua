...
rot_level19S = 190
rot_level19S_drop = "tutorial:level19_rot"


rot_level20 = 210
rot_level20_drop = "tutorial:coin_rot 4"
rot_level20S = 210
rot_level20S_drop = "tutorial:level20_rot"
rot_level20SS = 210
rot_level20SS_drop = "tutorial:xp_rot"

rot_levelMAX = 250
rot_levelMAX_drop = "tutorial:coin_rot 5"
rot_levelMAXS = 250
...
if new_xpr == rot_level20SS then
						minetest.env:add_item(pos, rot_level20SS_drop)
						minetest.sound_play("level_up", {
							to_player = player:get_player_name(),
						})
					end
