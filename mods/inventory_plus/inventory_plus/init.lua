...
inven.get_formspec = function(player, pos)
	...
	formspec = "size[8,5.3]"
        .."background[8,5.3;1,1;gui_formbg.png;true]"
        .."listcolors[#00000069;#5A5A5A;#141318;#30434C;#FFF]"
        .."bgcolor[#080808BB;true]"
		.."button[3,0;2,0.5;main;Back]"
		.."button[0,1;2,0.5;bags;Bags]"
		.."button[3,1;2,0.5;armor;Armor]"
		.."button[6,1;2,0.5;xp_gui;Xp Guide]"
		.."button[0,2;2,0.5;cr;Crafting]"
		.."button[3,2;2,0.5;skins;Skins]"
		.."button[6,2;2,0.5;zcg;Craft Guide]"
		.."button[0,3;2,0.5;kri;Crystals]"
		.."button[3,3;2,0.5;ach;Achievements]"
        .."button[6,3;2,0.5;rg;Regnum guide]"
        .."button[0,4;2,0.5;aw;Awards]"
        .."button[3,4;2,0.5;xpi0;Xp items]"
        .."button[6,4;2,0.5;gem;Gems]"
        .."button[1.5,5;2,0.5;artifacts;Artifacts]"
        .."button[4.6,5;2,0.5;medallion;Medallion]"
	    return formspec
end
