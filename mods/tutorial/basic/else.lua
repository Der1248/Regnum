...
rg19.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,1.6;Here you can see witch kind of armor/battleaxe/gun you have to craft:]"
        .."label[0,1.9;(starter)]"
        .."label[0,2.2;mega lv.1-20]"
        .."label[0,2.5;cloud lv.1-20]"
        .."label[0,2.8;super lv.1-4]"
        .."label[0,3.1;uranium lv.1-2 (no gun yet)]"
        .."label[0,3.4;energie lv.1-12 (no gun yet)]"
        .."label[0,3.7;superenergy lv.1-7 (no gun yet)]"
        .."label[0,4.0;crystal lv.1-5 (no gun yet)]"
        .."label[0,4.3;ultra lv.1-25 (no gun yet)]"
        .."label[0,4.6;superultra (no gun yet)]"
        .."label[0,4.9;arena lv.1-4 (no gun yet)]"
        .."label[0,5.2;titan lv.1-10 (no gun yet)]"
        .."label[0,5.5;legendary lv.1-6 (no gun yet)]"
        .."label[0,5.8;superlegendary (no gun yet)]"
        .."label[0,6.1;regnum (no gun yet)]"
...
minetest.register_on_dignode(function(pos, node, player)
    ...
    if node.name == "tutorial:geschenk_tortoise" then
        ...
        if x == 8 then
            ...
            local dgon = inv:get_stack("ttoise", 1):get_count()
            if dgon == 0 then
    ...
    if node.name == "tutorial:geschenk_gem2" then
        local x = math.random(0,8)
        if x == 2 then
            inv:add_item("main", "tutorial:gem_fragment2")
        elseif x == 5 then
            inv:add_item("main", "tutorial:geschenk_legend")
        elseif x == 4 then
            inv:add_item("main", "tutorial:geschenk_legend")
    ...
    if node.name == "tutorial:geschenk" then
        ...
        elseif x < 18 then
            inv:add_item("main", "default:mese_crystal 1")
        elseif x < 24 then
            inv:add_item("main", "default:ice")
        elseif x < 27 then
            inv:add_item("main", "tutorial:dunklematerie4")
        elseif x < 29 then
            inv:add_item("main", "tutorial:geschenk 2")
        else
            inv:add_item("main", "tutorial:geschenk 3")
        end
	end
    if node.name == "tutorial:geschenk_silber" then
        ...
        if x < 9 then
            inv:add_item("main", "tutorial:geschenk 2")
        elseif x < 15 then
            inv:add_item("main", "tutorial:lightstone 8")
        elseif x < 18 then
    ...
    if node.name == "tutorial:geschenk_platin" then
        local x = math.random(1, 10)
        if x < 5 then
            inv:add_item("main", "default:mese_crystal 4")
        elseif x < 8 then
            inv:add_item("main", "tutorial:geschenk_wool 4")
        elseif x < 10 then
            inv:add_item("main", "tutorial:geschenk_wool1 3")
        else
            inv:add_item("main", "tutorial:geschenk_wool2 2")
        end
	end
    ...
    if node.name == "tutorial:geschenk_wool2" then
        ...
        if x == 1 then
            inv:add_item("main", "wool:yellow 5")
        elseif x == 2 then
            inv:add_item("main", "wool:white 5")
        elseif x == 3 then
            inv:add_item("main", "wool:violet 5")
        elseif x == 4 then
            inv:add_item("main", "wool:red 5")
        elseif x == 5 then
            inv:add_item("main", "wool:pink 5")
        elseif x == 6 then
            inv:add_item("main", "wool:orange 5")
        elseif x == 7 then
            inv:add_item("main", "wool:magenta 5")
        elseif x == 8 then
            inv:add_item("main", "wool:grey 5")
        elseif x == 9 then
            inv:add_item("main", "wool:green 5")
        elseif x == 10 then
            inv:add_item("main", "wool:dark_grey 5")
        elseif x == 11 then
            inv:add_item("main", "wool:dark_green 5")
        elseif x == 12 then
            inv:add_item("main", "wool:cyan 5")
        elseif x == 13 then
            inv:add_item("main", "wool:brown 5")
        elseif x == 14 then
            inv:add_item("main", "wool:blue 5")
        else
            inv:add_item("main", "wool:black 5")
        end
	end
end)
local rg14 = {}
rg14.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."bgcolor[#080808BB;true]"
		.."label[0,1;I. 12. Gems]"
        .."label[0,1.3;Use the gem inventory to get home and fast privs.]"
...
rg8.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,2.5;You can see the craftings for battleaxes/armor/gun ]"
        .."label[0,2.8;in the Regnum Craft Guide.]"
        .."label[0,3.1;How to use Craft guide:]"
        .."label[0,3.4;1. Click on one item and you see the crafting above]"
        .."label[0,3.7;2. Click on the arrows below to switch to an other page]"
        .."label[0,4.0;3. Click on the arrows below 'main' to see the last]"
        .."label[0,4.3;   crafting you use]"
        .."label[0,4.6;4. Click on the arrows above and below the item to see]"
        .."label[0,4.9;   differend craftings for the same things]"
        .."label[0,5.2;5. Click on the 'Regnum' for armor/battleaxe/gun crafts]"
...
xpi0.get_formspec = function(player, pos)
	...
	formspec = "size[18,12.3]"
        ...
        .."listcolors[#00000069;#5A5A5A;#141318;#30434C;#FFF]"
        .."bgcolor[#080808BB;true]"
        .."list[detached:"..player:get_player_name().."_xpi01;xpi01;5.5,1.1;5,1]"
        .."list[detached:"..player:get_player_name().."_xpi01;xpi02;5.5,2.3;5,1]"
        .."list[detached:"..player:get_player_name().."_xpi01;xpi03;5.5,3.5;5,1]"
        .."list[detached:"..player:get_player_name().."_xpi01;xpi04;5.5,4.7;5,1]"
        .."list[detached:"..player:get_player_name().."_xpi01;xpi05;5.5,5.9;5,1]"
        ...
        .."label[5.5,0.7;Green Xp Items]"
        .."label[5.5,1.9;Red Xp Items]"
        .."label[5.5,3.1;Blue Xp Items]"
        .."label[5.5,4.3;Grey Xp Items]"
        .."label[5.5,5.5;Yellow Xp Items]"
...
rg6.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,1.3;There are 8 differend crafts:]"
        ...
        .."label[0,3.1;The Mine craft to level you mining laser/drill up.]"
        .."label[0,3.4;The Cooking craft, works like furnaces but without fuel]"
        .."label[0,3.7;The Medallion craft to get medallions]"
        .."label[0,4.0;Look in the Craft Guide which item you can craft in 4x4, 5x5 and cooking craft]"
        .."label[0,4.3;For Regnum craft you need regnum pixel.]"
        .."label[0,4.6;You can get them from Regnum gifts.]"
        .."label[0,4.9;For DNA craft you need dna strings.]"
        .."label[0,5.2;You can get them from monsters.]"
        .."label[0,5.5;You will get an animal spawn-egg if this animal has 100%.]"
        .."label[0,5.8;For Gem craft you need gem fragments and uranium ingots]"
        .."label[0,6.1;For Mine craft you need the mining laser/drill and green coins]"
        .."label[0,6.4;to level you mining laser/drill up.]"
        .."label[0,6.7;For Medallion craft you need Medallions.]"
        .."label[0,7.0;You will get them if you run around]"
        .."label[0,7.3;How to use Crafting:]"
        .."label[0,7.6;1. For 4x4, 5x5, Regnum, Gem, Medallion craft and Cooking you need a key]"
        .."label[0,7.9;2. Craft the key and put the needed items in the fields]"
        .."label[0,8.2;3. Press 'craft/build DNA']"
...
rg7.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,2.2;If you have the knight Regnum key you can use the knight skins]"
        .."label[0,2.5;How to use Skins:]"
        .."label[0,2.8;1. Click on one skin]"
        .."label[0,3.1;2. Craft the Pixeled Regnum key]"
        .."label[0,3.4;3. Press 'see-through skin']"
        .."label[0,3.7;4. Craft the Knight key]"
        .."label[0,4.0;5. Press 'knight']"
...
rg2.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,4.9;   12. Gems]"
        .."label[0,5.2;   13. Artifacts]"
        .."label[0,5.5;   14. Medallion]"
        .."label[0,5.8; II. Game]"
        .."label[0,6.1;   1. Gifts]"
        .."label[0,6.4;   2. Mobs]"
        .."label[0,6.7;   3. Xp & Level]"
        .."label[0,7.0;   4. Ores]"
        .."label[0,7.3;   5. Armor, Battleaxes & Guns]"
        .."label[0,7.6;   6. Chat commands]"
...
rg5.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,1.3;If you dig uranium/red ore/blue ore/Xp block/Xp Block (yellow) you will get xp.]"
        ...
        .."label[0,2.5;There are 5 differend kinds of xp.]"
        .."label[0,2.8;How to use Xp Guide:]"
        .."label[0,3.1;1. On the left you can see how many xp you have]"
        .."label[0,3.4;2. Craft the xp key and than you can press 'xp green/red/blue/grey/yellow you need']"
...
rg.get_formspec = function(player, pos)
	...
	formspec = "size[9,10.3]"
        ...
        .."label[0,3.7;In the next version (2.10.0) there will be:]"
        .."label[0,4.0;the new arenagun lv.1-4]"
        .."label[0,4.3;crystal craft funktion]"
        .."label[0,4.6;yellow xp lv.1-5]"
        .."label[0,4.9;?new monsters?]"
        .."label[0,5.2;?new achievements?]"
        .."label[0,5.5;?more armor changes?]"
...
ach.get_formspec = function(player, pos)
	...
	formspec = "size[12.5,11.3]"
        .."background[12.5,11.3;1,1;gui_formbg.png;true]"
        .."listcolors[#00000069;#5A5A5A;#141318;#30434C;#FFF]"
        .."bgcolor[#080808BB;true]"
		.."button[0,0;2,0.5;inven;Back]"
		.."button[2,0;2,0.5;main;Main]"
		...
		.."label[0.8,1.1;Regnumbattleaxe]"
		.."label[0.8,1.9;Bagkey Lv.4]"
		.."label[0.8,2.7.5;Armorkey]"
		.."label[0.8,3.5;Xp key]"
		.."label[0.8,4.3.5;Craftkey Lv.4]"
        ...
        .."label[3.3,7.5;Dragon key]"
        .."label[3.3,8.3;5 magic gems]"
        ...
        .."label[4,0;Achievements:]"
        .."label[5.5,0;"..d1.."/41]"
        .."button[10.5,0;2,0.5;rew;Reward (25)]"
	return formspec
end
--v.1.4.4
--v.1.4.3
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if fields.ach then
        ...
        local g4 = player_inv:get_stack("gem", 4):get_name()
        local g5 = player_inv:get_stack("gem", 5):get_name()
        local g11 = player_inv:get_stack("gem2", 1):get_name()
        local g12 = player_inv:get_stack("gem2", 2):get_name()
        local g13 = player_inv:get_stack("gem2", 3):get_name()
        local g14 = player_inv:get_stack("gem2", 4):get_name()
        local g15 = player_inv:get_stack("gem2", 5):get_name()
...
minetest.register_on_dignode(function(pos, node, player)
	...
	if node.name == "tutorial:geschenk_regnum" then
		...
		if x == 1 then
			inv:add_item("main", "tutorial:regnum_pixel_gold 20")
		elseif x == 2 then
			inv:add_item("main", "tutorial:regnum_pixel_green 20")
		elseif x == 3 then
			inv:add_item("main", "tutorial:regnum_pixel_purple 55")
		elseif x == 4 then
			inv:add_item("main", "tutorial:regnum_pixel_red 185")
		elseif x == 5 then
			inv:add_item("main", "tutorial:regnum_pixel_blue 185")
		end
	end
end)
--v.1.2.4
...
cr.get_formspec = function(player,pos)
	...
	formspec = "size[14,8.55]"
		...
		.."button[5,3.5;2,0.5;dna;DNA craft]"
        .."button[7,3.5;2,0.5;mine;Mining craft]"
...
xp_gui.get_formspec = function(player)
	...
	formspec = "size[8,8.3]button[0,0;2,0.5;inven;Back]"
        ...
        .."label[0,3;Xp cyan   (Part5) : comming soon]"
		.."list[current_player;main;0,4.25;8,1;]"
		.."list[current_player;main;0,5.5;8,3;8]"
		.."list[current_player;feld2;5,0;1,1;]"
		.."label[5,0.9;Xp key]"
		.."button[4,1.5;3.0,0.3;"..image1..";Xp green you need]"
		.."button[4,2.2;3.0,0.3;"..image2..";Xp red/blue you need]"
		.."button[4,2.9;3.0,0.3;"..image3..";Xp gray you need]"
        .."button[4,3.6;3.0,0.3;"..image4..";Xp yellow you need]"
	return formspec
end	
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if player == nil then
