...
minetest.register_chatcommand("regnum", {
	...
	func = function(name, param)
        ...
        inv:add_item("gem2", "tutorial:magic_gem1")
        inv:add_item("gem2", "tutorial:magic_gem2")
        inv:add_item("gem2", "tutorial:magic_gem3")
        inv:add_item("gem2", "tutorial:magic_gem4")
        inv:add_item("gem2", "tutorial:magic_gem5")
