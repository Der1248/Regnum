...
minetest.register_node("tutorial:geschenk_gold",{
	...
	drop = {
		max_items = 1,
		items = {
			{items = {'mobs:dirt_monster_egg'},rarity = 4,},
 			{items = {'mobs:stone_monster_egg'},rarity = 4,},
			{items = {'mobs:sand_monster_egg'},rarity = 4,},
			{items = {'default:mese 15'},rarity = 1,}
		}
	},
})
minetest.register_node("tutorial:geschenk_platin",{
	...
	drop = {
		max_items = 1,
		items = {
			{items = {'tutorial:geschenk_wool2 2'},rarity = 4,},
			{items = {'tutorial:geschenk_wool1 3'},rarity = 3,},
			{items = {'tutorial:geschenk_wool 4'},rarity = 2,},
			{items = {'default:mese 7'},rarity = 1,}
		}
	},
})
--v.0.19.1
minetest.register_node("tutorial:geschenk_silber",{
	...
	drop = {
		max_items = 1,
		items = {
			{items = {'tutorial:arena_glass'},rarity = 8,},
			{items = {'tutorial:arena_block'},rarity = 6,},
			{items = {'default:mese 3'},rarity = 3,},
			{items = {'tutorial:lightstone 8'},rarity = 2,},
			{items = {'tutorial:geschenk 2'},rarity = 1,}
		}
	},
})
...
minetest.register_node("tutorial:geschenk",{
	...
	drop = {
		...
		items = {
			...
			{items = {'tutorial:dunklematerie4'},rarity = 6,},
			{items = {'tutorial:geschenk 2'},rarity = 7,},
			{items = {'default:ice'},rarity = 3,},
			{items = {'default:mese 1'},rarity = 2,},
 			{items = {'tutorial:lightstone 3'},rarity = 1,}
		}
	},
})
--v.0.16.0
