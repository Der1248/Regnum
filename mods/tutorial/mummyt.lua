...
mummy_mesh = "mobs_stone_monster.b3d"
mummy_texture = {"mobs_stone_monster.png"}
mummy_hp = 500
mummy_drop = "tutorial:geschenkpapier 64"
...
minetest.register_entity("tutorial:test", MUMMY_DEF)
minetest.register_entity("tutorial:test_spawner", spawner_DEF)


--spawn-egg/spawner

minetest.register_craftitem("tutorial:spawn_eggt", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		if pointed_thing.type == "node" then
			minetest.env:add_entity(pointed_thing.above,"tutorial:test")
