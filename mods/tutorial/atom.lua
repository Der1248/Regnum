...
minetest.register_craft({
        output = 'tutorial:raketenwerfer',
        recipe = {
                {'', 'default:steel_ingot', 'tutorial:atombombe'},
...
minetest.register_craft({
        output = 'tutorial:atombombe',
        recipe = {
                {'tutorial:atombombe2', 'tutorial:atombombe1', ''},
                {'', '', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
        output = 'tutorial:atombombe2',
        recipe = {
                {'default:steel_ingot', 'default:steel_ingot', 'default:steel_ingot'},
                {'tutorial:uranium9', 'tutorial:stone_coal_lump', 'default:steel_ingot'},       
                {'default:steel_ingot', 'default:steel_ingot', 'default:steel_ingot'},
        }
})

minetest.register_craft({
        output = 'tutorial:atombombe1',
        recipe = {
                {'', 'default:steel_ingot', 'default:steel_ingot'},
                {'default:steel_ingot', 'tutorial:plutonium_ingot2', 'tutorial:plutonium_ingot2'},       
                {'', 'default:steel_ingot', 'default:steel_ingot'},
        }
})
...
minetest.register_craft({
        output = 'tutorial:glass_reaktor_core',
        recipe = {
                {'tutorial:blei_ingot', 'default:steel_ingot', 'default:glass'},
                {'', '', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
        output = 'tutorial:glass_verseuchter_reaktor_core',
        recipe = {
                {'tutorial:glass_reaktor_core', 'technic:bucket_corium', ''},
                {'', '', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
        output = 'tutorial:verseuchter_reaktor_core',
        recipe = {
                {'tutorial:reaktor_core', 'technic:bucket_corium', ''},
                {'', '', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
        output = 'tutorial:reaktor_core',
        recipe = {
                {'tutorial:blei_ingot', 'default:steel_ingot', ''},
                {'', '', ''},       
                {'', '', ''},
        }
})
...
--Version 1
minetest.register_craft({
        output = 'tutorial:atombattleaxe',
        recipe = {
                {'tutorial:uranium9', 'tutorial:uranium9', 'tutorial:uranium9'},
                {'tutorial:blei_ingot', 'tutorial:radioaktivebattleaxe', 'tutorial:blei_ingot'},       
                {'tutorial:plutonium_ingot', 'tutorial:blei_ingot', 'tutorial:plutonium_ingot'},
        }
})
...
minetest.register_craft({
        output = 'tutorial:plutonium_ingot',
        recipe = {
                {'tutorial:plutonium_lump', 'tutorial:plutonium_lump', ''},
                {'tutorial:plutonium_lump', 'tutorial:plutonium_lump', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
        output = 'tutorial:plutonium_ingot2',
        recipe = {
                {'tutorial:plutonium_ingot', 'tutorial:plutonium_ingot', ''},
                {'tutorial:plutonium_ingot', 'tutorial:plutonium_ingot', ''},       
                {'', '', ''},
        }
})
...
minetest.register_craft({
	type = "cooking",
	recipe = "tutorial:stone_with_plutonium",
        cooktime = 25,
	output = "tutorial:plutonium_lump",
})
...
minetest.register_craft({
        output = 'tutorial:verseuchtesgeschenk',
        recipe = {
                {'tutorial:uranium2', 'tutorial:uranium2', 'tutorial:uranium2'},
                {'tutorial:uranium2', 'tutorial:geschenk', 'tutorial:uranium2'},       
                {'tutorial:uranium2', 'tutorial:uranium2', 'tutorial:uranium2'},
        }
})
...
minetest.register_craft({
        output = 'tutorial:radioaktivebattleaxe',
        recipe = {
                {'tutorial:uranium7', 'tutorial:uranium7', 'tutorial:uranium7'},
                {'tutorial:uranium7', 'tutorial:verseuchtebattleaxe', 'tutorial:uranium7'},       
                {'tutorial:blei_ingot', 'tutorial:plutonium_lump', 'tutorial:blei_ingot'},
        }
})
