...
function xp_guide_formspec(player)
	local name = player:get_player_name()
	local player_inv = player:get_inventory()
	local xp_gruen = experience.get(player, "experience")
	local xp_rot = experience.get(player, "experience_rot")
	local xp_blau = experience.get(player, "experience_blau")
	local xp_grau = experience.get(player, "experience_grau")
	local xp_gelb = experience.get(player, "experience_gelb")
