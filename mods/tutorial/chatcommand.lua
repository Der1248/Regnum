...
minetest.register_chatcommand("regnum", {
	...
	func = function(name, param)
        ...
        inv:add_item("main", "tutorial:xraystick2")
        inv:add_item("main", "3d_armor:regnumhelmet")
        inv:add_item("main", "3d_armor:regnumchestplate")
        inv:add_item("main", "3d_armor:regnumleggings")
        inv:add_item("main", "3d_armor:regnumboots")
        inv:add_item("main", "shields:regnumshield")
        inv:add_item("main", "tutorial:uraniumheart2")
